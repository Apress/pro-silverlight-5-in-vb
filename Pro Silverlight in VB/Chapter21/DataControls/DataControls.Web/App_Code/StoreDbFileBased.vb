...
Public Class StoreDb
    ...
    Public Function GetProduct(ByVal ID As Integer) As Product
        ...
        Dim product As Product = New Product(CStr(productRow("ModelNumber")), CStr(productRow("ModelName")), Convert.ToDouble(productRow("UnitCost")), CStr(productRow("Description")), CStr(productRow("CategoryName")), CStr(productRow("ProductImage")))
        Return product
    End Function
